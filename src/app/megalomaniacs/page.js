...
export default function MegalomaniacsPage() {
  // Keep lines IN SCOPE for the component:
  const lines = [
    ...
    >
      ...
      <section className="relative z-10 max-w-3xl mx-auto px-6 py-16 md:py-24 text-soft">
        ...
        <div className="mt-10 text-center">
          ...
          >
            <span
              className="chaotic-arrow absolute -top-7 left-1/2 -translate-x-1/2 z-20 text-[hsl(var(--hugh))] text-3xl glow-fade glow-delay-2"
              aria-hidden="true"
            >
              <span className="inline-block float-rebel">↷</span>
            </span>

            <span className="relative btn-shimmer block rounded-full border border-white/10 bg-black/40 px-5 py-3 text-slate-300 backdrop-blur-sm shadow-[0_6px_30px_rgba(0,0,0,.35)] hover:text-white hover:border-white/20 hover:bg-black/60 transition-all duration-500">
